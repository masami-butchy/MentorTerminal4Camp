...
public class MemberListAdapter extends ArrayAdapter<RealmMemberObject>{
    ...
    public View getView(final int position, View convertView, ViewGroup paremt){
        ...
        if (item != null){
            ...
            setViewHolderTextX(item.textOne,viewHolder.button1,item,viewHolder);
            setViewHolderTextX(item.textTwo,viewHolder.button2,item,viewHolder);
            setViewHolderTextX(item.textThree,viewHolder.button3,item,viewHolder);
            setViewHolderTextX(item.textFour,viewHolder.button4,item,viewHolder);
            setViewHolderTextX(item.textFive,viewHolder.button5,item,viewHolder);
            setViewHolderTextX(item.textsix,viewHolder.button6,item,viewHolder);
            setViewHolderTextX(item.textSeven,viewHolder.button7,item,viewHolder);
            setViewHolderTextX(item.textEight,viewHolder.button8,item,viewHolder);
            setViewHolderTextX(item.textNine,viewHolder.button9,item,viewHolder);
            setViewHolderTextX(item.textTen,viewHolder.button10,item,viewHolder);
            setViewHolderTextX(item.textEleven,viewHolder.button11,item,viewHolder);
            setViewHolderTextX(item.textTwelve,viewHolder.button12,item,viewHolder);
            setViewHolderTextX(item.textThirteen,viewHolder.button13,item,viewHolder);
            setViewHolderTextX(item.textFourteen,viewHolder.button14,item,viewHolder);
            setViewHolderTextX(item.textFifteen,viewHolder.button15,item,viewHolder);
            setViewHolderTextX(item.textSixteen,viewHolder.button16,item,viewHolder);
            setViewHolderTextX(item.textSeventeen,viewHolder.button17,item,viewHolder);
            setViewHolderTextX(item.textEightteen,viewHolder.button18,item,viewHolder);
            setViewHolderTextX(item.textNineteen,viewHolder.button19,item,viewHolder);
            setViewHolderTextX(item.textTwenty,viewHolder.button20,item,viewHolder);
    ...
    public void setViewHolderTextX(final short textX, final TextView buttonX, final RealmMemberObject item, final ViewHolder viewHolder) {
